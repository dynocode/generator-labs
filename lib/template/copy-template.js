...
function createLint(that, toDirPath) {
  copyTpl(that, defaultFilePaths.eslintignore, path.join(toDirPath, '.eslintignore'));
  copyTpl(that, defaultFilePaths.eslintrc, path.join(toDirPath, '.eslintrc.js'));
